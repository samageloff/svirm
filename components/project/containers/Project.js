...
const JulioComponent = MyLoadable({
  ...
  webpack: () => [
    require.resolveWeak("src/components/julio-le-parc/containers/JulioLeParc"),
  ],
});
...
const InstabilityComponent = MyLoadable({
  ...
  webpack: () => [
    require.resolveWeak("src/components/instability/containers/Instability"),
  ],
});
...
const SequencesComponent = MyLoadable({
  ...
  webpack: () => [
    require.resolveWeak("src/components/sequences/containers/Sequences"),
  ],
});
